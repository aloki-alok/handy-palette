...
| Stale palette | Open the palette, click into another app. The palette must disappear rather than sit there without a caret. Press `Option-Command-K` once: it must open focused, not vanish. |
